...
namespace Oxide.Plugins
{
  ...
  [Info("Performance UI", "Suparious", "1.1.0")]
  [Description("Display real-time server performance metrics")]
  class PerformanceUI : RustPlugin
  {
    ...
    private void Init()
    {
      ...
      IconSize();
      cmd.AddChatCommand("perf", this, CmdChatPerformance);
    }
    ...
    [ConsoleCommand("perf.size")] //changes size of the UI
