                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="white-box">
                            <div class="d-md-flex mb-3">
                                <center><input type="text" id="myInput" onkeyup="myFunction()" placeholder="Filter"></center>
                            </div>
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            try {
                                                ...
                                                echo '<div id="paging" style="text-align: center;"><p>', $prevlink, ' Page ', $page, ' of ', $pages, ' pages, displaying ', $start, '-', $end, ' of ', $total, ' results ', $nextlink, ' </p></div>';

                                                $stmt = $database->prepare('SELECT * FROM users ORDER BY id LIMIT :limit OFFSET :offset');
